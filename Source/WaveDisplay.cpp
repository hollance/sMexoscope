...
void inline CWaveDisplay::drawAliasedLine(juce::Graphics& g, int x1, int y1, int x2, int y2)
{
    if (y2 > y1)
...
void CWaveDisplay::mouseDown(const juce::MouseEvent &event)
{
...
void CWaveDisplay::mouseDrag(const juce::MouseEvent &event)
{
    if (event.mods.isLeftButtonDown() && event.originalComponent == this)
    {
        // set position
...
void CWaveDisplay::mouseUp(const juce::MouseEvent &event)
{
...
//------------------------------------------------------------------------
void CWaveDisplay::paint(juce::Graphics& g)
{
    ///////////////////////////////////////////////////////
